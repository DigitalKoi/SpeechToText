...
import com.digitalkoi.speechtotext.mvi.speech.SpeechResult.ShowViewResult.ShowDialogGoodnessResult
import com.digitalkoi.speechtotext.mvi.speech.SpeechResult.ShowViewResult.ShowDialogIdResult
import com.digitalkoi.speechtotext.mvi.speech.SpeechResult.ShowViewResult.ShowKeyboardResult
...
class SpeechActionProcessorHolder(
  ...
  private val showDialogGoodnessProcessor =
    ObservableTransformer<ShowDialogGoodnessAction, ShowDialogGoodnessResult> { actions ->
      actions.map { state -> ShowViewResult.ShowDialogGoodnessResult(state.showView) }
          .subscribeOn(schedulerProvider.io())
          .observeOn(schedulerProvider.ui())
    }
      ...
      action.publish { shared ->
        Observable.merge(
            listOf(
                ...
                shared.ofType(ShowDialogGoodnessAction::class.java).compose(showDialogGoodnessProcessor),
